...
# Define the names of the countries corresponding to identifiers for clarity in naming columns
...
for (i in seq_along(control_countries)) {
    ...
    # Store the results in the dataframe under the appropriate country name
...
# Filter the all_leave_one_out_path_data to keep only the significant countries
#all_significant_leave_one_out <- all_leave_one_out_path_data[columns_to_keep]
